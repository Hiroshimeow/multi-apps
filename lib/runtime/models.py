...
class RunRecord:
    ...
    def __post_init__(self) -> None:
        ...
        self.launcher_id = str(self.launcher_id)
        ...
        if not self.app_id or not self.run_id or not self.launcher_id:
            raise ValueError("app_id, run_id, and launcher_id are required")
